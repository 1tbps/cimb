        ...
        <div class="modal-body">
          ...
          <form class="row g-3" method="POST" id="form-cad-comp">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-outline-primary" value="cadastrar">Salvar Mudanças</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="row g-3" method="POST" id="form-edi-comp">
            ...
            <div class="col-md-6">
              <label for="fld-ult_usuario" class="form-label">Último Usuário</label>
              <input type="text" name="fld-ult_usuario" class="form-control" id="fld-ediult_usuario" placeholder="Primeiro Nome">
            </div>
            <div class="col-md-6">
              <label for="fld-patrimonio_cpu" class="form-label">Patrimônio da CPU</label>
              <input type="text" name="fld-patrimonio_cpu" class="form-control" id="fld-edipatrimonio_cpu" placeholder="">
            </div>
            <div class="col-md-6">
              <label for="fld-servicetag_cpu" class="form-label">Service Tag</label>
              <input type="text" name="fld-servicetag_cpu" class="form-control" id="fld-ediservicetag_cpu" placeholder="">
            </div>
            <div class="col-md-9">
              <label for="fld-office_email" class="form-label">E-Mail do Office</label>
              <input type="email" name="fld-office_email" class="form-control" id="fld-edioffice_email" placeholder="">
            </div>
            <div class="col-md-3">
              <label for="fld-office_senha" class="form-label">Senha do Office</label>
              <input type="text" name="fld-office_senha" class="form-control" id="fld-edioffice_senha" placeholder="">
            </div>
            <div class="col-md-9">
              <label for="fld-office_serial" class="form-label">Serial do Office</label>
              <input type="text" name="fld-office_serial" class="form-control" id="fld-edioffice_serial" placeholder="">
            </div>
            <div class="col-md-3">
              <label for="fld-sigla_coord" class="form-label">Coord.</label>
