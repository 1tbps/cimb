...
if (empty($dados['fld-nome_cpu'])) {
  ...
  $cad_computador->bindParam(':nome_cpu', $dados['fld-nome_cpu']);
  ...
  $cad_computador->bindParam(':coord_id', $dados['fld-sigla_coord']);
  $cad_computador->bindParam(':setor_id', $dados['fld-nome_setor']);
